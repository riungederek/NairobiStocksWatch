...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8 max-w-7xl">
                ...
                <TabsContent value="watchlist" className="space-y-4">
                  ...
                  {watchlistStocks.length === 0 ? (
                    <Card className="p-12 text-center">
                      ...
                      <Button onClick={() => document.querySelector<HTMLButtonElement>('[data-testid="tab-trending-mobile"]')?.click()}>
                        Browse Stocks
                      </Button>
                    </Card>
                  ) : (
